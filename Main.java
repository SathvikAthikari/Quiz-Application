...
public class Main {
    ...
    private static final String DB_PASS = "Sathvik@2004";// Use your own password
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            while(true){
                ...
                switch(n){
                    //Only one admin is allowed in this application whose password is already set for his/her login
